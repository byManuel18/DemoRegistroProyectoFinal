...
public class Envase implements Comparable<Envase>{
	protected int id_p;
	...
	public Envase(LocalDate fecha_llegada, String proveedor, String mercancia, String lote,
	...
	public Envase(int id_p, LocalDate fecha_llegada, String proveedor, String mercancia, String lote,
			LocalDate fecha_in, LocalDate fecha_fin, Estado firmado) {
		this.id_p = id_p;
	...
	public String toString() {
		return "Envase -->" +"Fecha Legada=" + fecha_llegada + ", Proveedor=" + proveedor + ", Mercancia="
